...
def test_tiny_acted_together():
    actor1 = 2876
    actor2 = 4724
    assert lab.acted_together(db_tiny, actor1, actor2) is True
...
# TEST FOR ACTOR TO ACTOR PATH

def test_tiny_actor_to_actor_path():
    expected = [2876,1640]
    result = lab.actor_to_actor_path(db_tiny, 2876, 1640)
    assert expected == result
